      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6 stagger-fade-in w-full max-w-full overflow-hidden">
        {isLoading ? (
          ...
          Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="relative w-full max-w-full" style={{ animationDelay: `${index * 0.1}s` }}>
              <div className="relative aspect-[3/4] overflow-hidden rounded-lg md:rounded-xl">
